...
namespace JU.CharacterSystem.AI
{
    ...
    public class JUCharacterAIBase : MonoBehaviour
    {
        ...
        {
            Vector3 lookDirection = Control.LookToDirection;
        ...
        private void UpdateCharacterControls()
        {
            ...
            Character.DefaultUseOfAllItems(attacking, attacking, attacking, false, false, attacking, attacking && !Character.RightHandWeapon);
