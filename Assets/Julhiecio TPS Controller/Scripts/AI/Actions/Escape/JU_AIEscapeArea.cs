...
namespace JU.CharacterSystem.AI.EscapeSystem
{
    ...
    public class JU_AIEscapeArea : MonoBehaviour
    {
        ...
        /// <summary>
        /// Refresh the used area, useful if you need to move this area to another position and
        /// for some reason the bounds was not updated as needed.
        /// </summary>
        ...
        /// <summary>
        /// Returns the bounds area of this <see cref="JU_AIEscapeArea"/>.
        /// </summary>
