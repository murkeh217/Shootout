...
namespace JU.CharacterSystem.AI
{
    ...
    public class JU_AI_Zombie : JUCharacterAIBase, IOnSetTarget, IOnHear
    {
        ...
        protected override void Start()
        {
            ...
            Hear.Setup(this);
            Hear.OnHear.AddListener(OnHearSomething);
        }
        ...
        private void UpdateCurrentState()
        {
            ...
            if (OnHearSoundBehavior == OnHearSoundBehaviors.SearchTarget || CurrentTarget == null)
            {
            ...
            else if (OnHearSoundBehavior == OnHearSoundBehaviors.AttackTarget)
            {
                if (FieldOfView.IsOnView(CurrentTarget))
                {
                    _searchLastTargetTimer = 0;
                    _lastTargetPosition = CurrentTarget.bounds.center;
                    CurrentState = ZombieState.Attacking;
        ...
        private void OnHearSomething(Vector3 position, GameObject source)
        {
            ...
            {
                _searchLastTargetTimer = 0;
                _lastTargetPosition = sourceCollider.bounds.center;
