...
namespace JUTPS.WeaponSystem
{
    ...
    public class Weapon : JUHoldableItem
    {
        ...
        public float CurrentFireRateToShoot { get; set; }
        ...
        public float ShotErrorProbability { get; set; }
        ...
        protected override void Start()
        {
            ...
            if (Owner != null)
            {
                if (Owner.TryGetComponent(out JUCharacterController thirdPersonController))
                {
                    ...
                    ListToIgnoreBulletCollision = thirdPersonController.HitBoxes.ToArray();
                }
