...
namespace JUTPS.GameSettings
{
    ...
    public class JUGameSettings : MonoBehaviour
    {
        ...
        private const string CONTROLS_USE_AIM_ASSIST_KEY = "SETTINGS_CONTROLS_AIM_ASSIST";
        ...
        /// <summary>
        /// Use camera aim assist?
        /// </summary>
        public static bool UseAimAssist
        {
            get
            {
                return PlayerPrefs.GetInt(CONTROLS_USE_AIM_ASSIST_KEY, 1) == 1 ? true : false;
            }
            set
            {
                PlayerPrefs.SetInt(CONTROLS_USE_AIM_ASSIST_KEY, value ? 1 : 0);
                OnChangeSettings?.Invoke();
            }
        }
