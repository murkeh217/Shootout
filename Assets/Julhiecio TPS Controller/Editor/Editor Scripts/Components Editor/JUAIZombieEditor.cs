...
namespace JUTPSEditor
{
    ...
    public class JU_AI_ZombieCharacterEditor : Editor
    {
        ...
        private SerializedProperty _onHearSoundBehavior;
        ...
        void OnEnable()
        {
            ...
            _onHearSoundBehavior = serializedObject.FindProperty(nameof(_zombieAI.OnHearSoundBehavior));
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_showStates)
            {
                ...
                EditorGUILayout.PropertyField(_onHearSoundBehavior);
