	...
	while(dungeonSizeCounter<dungeonSize){
		for(int i = 0; i<roomSize;i++){
			for(int j = 0; j<roomSize;j++){
				...
				if (hasRoof)
					...
					if(j==0){ 	
						GameObject toClean1 = Instantiate(walls[Random.Range(0,walls.Length)],new  Vector3(-2+(j*sizeOfInt)+grTrZ,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0, 180, 0));
					...
					if(dungeonSizeCounter!=0){
						if(i==0&&j!=oldDoorPlace){
							GameObject toClean1 =Instantiate(walls[Random.Range(0,walls.Length)],new  Vector3(0+(j*sizeOfInt)+grTrZ,transformY,groundTransforamZ-2+(i*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
							objectsToCleanDungeon.Add(toClean1);
						}
					}
					else{
					...
					if(SetRangeChance(wallEnvRange)&&environmentToWall.Length>0){
						if(j==0&&i!=oldDoorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-1.4f+(j*sizeOfInt)+grTrZ,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(j==roomSize-1&&i!=doorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(1.4f+(j*sizeOfFloat)+grTrZ,transformY,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(i==0&&j!=oldDoorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-2f+(j*sizeOfFloat)+grTrZ,transformY,-1.4f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					...
					if(SetRangeChance(lampsRange)&&lamps.Length>0){
						if(j==0&&i!=oldDoorPlace&&i%3==0){
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-1.9f+(j*sizeOfInt)+grTrZ,1.7f+transformY,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
							...
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-2f+(j*sizeOfFloat)+grTrZ,1.7f+transformY,1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,00, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					}
					...
					if(SetRangeChance(columnRange)&&columns.Length>0){
						if(j==0&&i!=oldDoorPlace){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-2f+(j*sizeOfFloat)+grTrZ,transformY,-1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
							...
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(j*sizeOfFloat)+grTrZ,transformY,-2f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(i==roomSize-1&&j!=doorPlace){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(j*sizeOfFloat)+grTrZ,transformY,2f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
		...
		if(dungeonSizeCounter==0||dungeonSizeCounter==dungeonSize-1){
			...
			for(int m = 0; m<tunelSizeX;m++){
				...
				GameObject toClean2 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)+(m*sizeOfInt)+grTrZ,transformY,-2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
				GameObject toClean3 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)+(m*sizeOfInt)+grTrZ,transformY,2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
				objectsToCleanDungeon.Add(toClean2);
			...
			while(dungeonSizeCounterRight<dungeonSizeRight){
					...
					for(int v = 0; v<roomSize;v++){
						...
						if (hasRoof)
							...
							if(v==0&&s!=doorPlaceX){ 	
								GameObject toClean2= Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(roomSize*sizeOfInt)+(groundTransforamX)+(v*sizeOfInt),transformY,groundTransforamZ+(s*sizeOfInt)) , Quaternion.Euler(0, 180, 0));
								objectsToCleanDungeon.Add(toClean2);
							} 
							...
							if(dungeonSizeCounterRight!=0){
								if(s==0){
									GameObject toClean2=	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(0+(roomSize*sizeOfInt)+(groundTransforamX)+(v*sizeOfInt),transformY,groundTransforamZ-2+(s*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
									objectsToCleanDungeon.Add(toClean2);
								}
							}
							else{
					...
					if(SetRangeChance(wallEnvRange)&&environmentToWall.Length>0){
						if(v==0&&s!=oldDoorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-1.4f+(roomSize*sizeOfInt)+(v*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+(s*sizeOfInt)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(v==roomSize-1&&s!=doorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(1.4f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,transformY,groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(s==0&&v!=oldDoorPlace){
							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-2f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,transformY,-1.4f+groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					...
					if(SetRangeChance(lampsRange)&&lamps.Length>0){
						if(v==0&&s!=oldDoorPlace&&s%3==0){
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-1.9f+(roomSize*sizeOfInt)+(v*sizeOfInt)+groundTransforamX,1.7f+transformY,groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
							...
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-2f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,1.7f+transformY,1.9f+groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					}
					//Columns
					if(SetRangeChance(columnRange)&&columns.Length>0){
						if(v==0&&s!=oldDoorPlace){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-2f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,transformY,-1.9f+groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
							...
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,transformY,-2f+groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(s==roomSize-1&&v!=doorPlace){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(roomSize*sizeOfInt)+(v*sizeOfFloat)+groundTransforamX,transformY,2f+groundTransforamZ+(s*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
				...
				if(dungeonSizeCounterRight!=dungeonSizeRight-1){
					for(int p = 0; p<tunelSizeXTun;p++){
						...
						GameObject toCleansizeOfInt=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)*2+(p*sizeOfInt)+groundTransforamX,transformY,-2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
						GameObject toClean5=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)*2+(p*sizeOfInt)+groundTransforamX,transformY,2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
					...
					GameObject toClean3=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(roomSize*sizeOfInt)*2+groundTransforamX,transformY,(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
					objectsToCleanDungeon.Add(toClean3);
				}
		...
		if(dungeonSizeCounter!=dungeonSize-1){
			...
			for(int n = 0; n<tunelSize;n++){
				...
				GameObject toClean7=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2+(doorPlace*sizeOfInt)+grTrZ,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				GameObject toClean8=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(doorPlace*sizeOfInt)+grTrZ,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
			...
			GameObject toClean6=Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(doorPlace*sizeOfInt+grTrZ,transformY,-2+(roomSize*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
			objectsToCleanDungeon.Add(toClean6);
		}
...
//		int nextDoorSide = 2; // 0 - West, 1 South, 2 Ost, 3 North
		for(int i = 0; i<roomSizeI;i++){
				for(int j = 0; j<roomSizeJ;j++){
					...
					{
						if(j==0&&i!=dootPlaceJ){ 	
							GameObject	toClean3 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0, 180, 0));
							objectsToCleanDungeon.Add(toClean3);
						}
						if(i==roomSizeI-1){
							GameObject	toClean3 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(0+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+2+(i*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
							objectsToCleanDungeon.Add(toClean3);
						}
						if(i==0){
							GameObject	toClean3 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(0+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ-2+(i*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
					...
					else
					{
						if (nextDoorSide == 0 && entranceDoorPlace == 2)
						{
							if (j == 0 && i != dootPlaceJ)
							{
								GameObject toClea12 = Instantiate(walls[Random.Range(0, walls.Length)],
									new Vector3(-2 + (j * sizeOfInt) + groundTransforamX, transformY,
										groundTransforamZ + (i * sizeOfInt)), Quaternion.Euler(0, 180, 0));
							...
							if (i == roomSizeI - 1)
							{
								GameObject toClea12 = Instantiate(walls[Random.Range(0, walls.Length)],
									new Vector3(0 + (j * sizeOfInt) + groundTransforamX, transformY,
										groundTransforamZ + 2 + (i * sizeOfInt)), Quaternion.Euler(0, 90, 0));
								objectsToCleanDungeon.Add(toClea12);
							}
...
//							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-1.9f+(j*sizeOfInt)+groundTransforamX,1.7f,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
//							environmentToClean.Add(new Tunnel(generatedDungeonNumber,toClean2));
//						}
//						else if(j==0&&i!=entranceDoorPlaceJ){
//							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-1.4f+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0,180, 0));
//							environmentToClean.Add(new Tunnel(generatedDungeonNumber,toClean2));
//						}
...
//							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(1.4f+(j*sizeOfFloat)+groundTransforamX,transformY,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
//							environmentToClean.Add(new Tunnel(generatedDungeonNumber,toClean2));
//						}
...
//							GameObject toClean2 = Instantiate(environmentToWall[Random.Range(0,environmentToWall.Length)],new Vector3(-2f+(j*sizeOfFloat)+groundTransforamX,transformY,-1.4f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
//							environmentToClean.Add(new Tunnel(generatedDungeonNumber,toClean2));
//						}
//						else if(i==roomSizeI-1&&j!=doorPlaceI&&j%3==0){
//							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-2f+(j*sizeOfFloat)+groundTransforamX,1.7f,1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
//							environmentToClean.Add(new Tunnel(generatedDungeonNumber,toClean2));
//						}
...
//					}
					...
					if(SetRangeChance(columnRange)&&columns.Length>0){
						if(j==0&&i!=entranceDoorPlaceJ){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-2f+(j*sizeOfFloat)+groundTransforamX,transformY,-1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
							...
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(j*sizeOfFloat)+groundTransforamX,transformY,-2f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(i==roomSizeI-1&&j!=doorPlaceI){
							GameObject toClean2 = Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-1.9f+(j*sizeOfFloat)+groundTransforamX,transformY,2f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
		...
		if(nextDoorSide==0){
			...
			for(int m = 0; m<tunelSizeX;m++){
				...
				GameObject tunelToCleansizeOfInt = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-sizeOfFloat-(m*sizeOfFloat)+groundTransforamX,transformY,-2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
				GameObject tunelToClean5 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-sizeOfFloat-(m*sizeOfFloat)+groundTransforamX,transformY,2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
			...
			for(int n = 0; n<tunelSize;n++){
				if (columns.Length > 0)
				{
					GameObject tunelToClean1 = Instantiate(columns[Random.Range(0, columns.Length)],
						new Vector3(-2f + doorPlaceI * sizeOfInt + groundTransforamX, transformY,
							-5.9f - (n * sizeOfFloat) + groundTransforamZ), Quaternion.Euler(0, 90, 0));
					GameObject tunelToClean2 = Instantiate(columns[Random.Range(0, columns.Length)],
						new Vector3(2f + doorPlaceI * sizeOfInt + groundTransforamX, transformY,
							-5.9f - (n * sizeOfFloat) + groundTransforamZ), Quaternion.Euler(0, 90, 0));
					objectsToCleanDungeon.Add(tunelToClean1);
				...
				GameObject tunelToCleansizeOfInt =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,-sizeOfFloat-(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				GameObject tunelToClean5 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,-sizeOfFloat-(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
			...
			canCreateDungeon = true;
					...
					for(int m = 0; m<tunelSizeX;m++){
						...
						GameObject tunelToCleansizeOfInt =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSizeJ*sizeOfFloat)+(m*sizeOfFloat)+groundTransforamX,transformY,-2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
						GameObject tunelToClean5 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSizeJ*sizeOfFloat)+(m*sizeOfFloat)+groundTransforamX,transformY,2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
					...
					for(int n = 0; n<tunelSize;n++){
						...
						GameObject tunelToCleansizeOfInt =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
						GameObject tunelToClean5 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
	...
	while(dungeonSizeCounter<dungeonSize){
				...
				if (hasRoof)
					...
					if(SetRangeChance(lampsRange)&&lamps.Length>0){
						if(j==0&&i!=oldDoorPlace&&i%3==0){
							...
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-2f+(j*sizeOfFloat)+grTrZ,1.7f+transformY,1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					}
			...
			while(dungeonSizeCounterRight<dungeonSizeRight){
				...
				if(dungeonSizeCounterRight!=dungeonSizeRight-1){
					for(int p = 0; p<tunelSizeXTun;p++){
						...
						GameObject toClean2 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)*2+(p*sizeOfInt)+groundTransforamX,transformY,-2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
						GameObject toClean3 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSize*sizeOfInt)*2+(p*sizeOfInt)+groundTransforamX,transformY,2+(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
					...
					GameObject toClean1 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(roomSize*sizeOfInt)*2+groundTransforamX,transformY,(doorPlaceX*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				objectsToCleanDungeon.Add(toClean1);
				}
		...
		if(dungeonSizeCounter!=dungeonSize-1){
			for(int n = 0; n<tunelSize;n++){
				...
				GameObject toClean2 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2+(doorPlace*sizeOfInt)+grTrZ,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				GameObject toClean3 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(doorPlace*sizeOfInt)+grTrZ,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				objectsToCleanDungeon.Add(toClean2);
				objectsToCleanDungeon.Add(toClean3);
			}
		}
		else{
			GameObject toClean1 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(doorPlace*sizeOfInt+grTrZ,transformY,-2+(roomSize*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
			objectsToCleanDungeon.Add(toClean1);
		}
	...
	while(dungeonSizeCounter<dungeonSize){
		for(int i = 0; i<roomSize;i++){
			for(int j = 0; j<roomSize;j++){
				...
				if (hasRoof)
					...
					if(j==0){ 	
					GameObject toClean1 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0, 180, 0));
					objectsToCleanDungeon.Add(toClean1);
					} 
					...
					if(dungeonSizeCounter!=0){
						if(i==0&&j!=oldDoorPlace){
							GameObject toClean1 =	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(0+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ-2+(i*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
							objectsToCleanDungeon.Add(toClean1);
						}
					}
					else{
					...
					if(SetRangeChance(lampsRange)&&lamps.Length>0){
						if(j==0&&i!=oldDoorPlace&&i%3==0){
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-1.9f+(j*sizeOfInt)+groundTransforamX,1.7f+transformY,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						else if(j==roomSize-1&&i!=doorPlace&&i%3==0){
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(1.9f+(j*sizeOfInt)+groundTransforamX,1.7f+transformY,groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,-180, 0));
							...
							GameObject toClean2 = Instantiate(lamps[Random.Range(0,lamps.Length)],new Vector3(-2f+(j*sizeOfFloat)+groundTransforamX,1.7f+transformY,1.9f+groundTransforamZ+(i*sizeOfFloat)) , Quaternion.Euler(0,90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					}
		...
		if(dungeonSizeCounter!=dungeonSize-1){
			for(int n = 0; n<tunelSize;n++){
				...
				GameObject toClean3 =	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2+(doorPlace*sizeOfInt)+groundTransforamX,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				GameObject toCleansizeOfInt =	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2+(doorPlace*sizeOfInt)+groundTransforamX,transformY,(roomSize*sizeOfInt)+(n*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
			...
			GameObject toClean1 =	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(doorPlace*sizeOfInt+groundTransforamX,transformY,-2+(roomSize*sizeOfInt)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
			objectsToCleanDungeon.Add(toClean1);
		}
		...
		while(dungeonSizeCounter<dungeonSize){
			for(int i = 0; i<roomSizeI;i++){
				for(int j = 0; j<roomSizeJ;j++){
					...
					if(isDoorPlaceX){
						if(j==roomSizeJ-1&&i!=dootPlaceJ){ 	
							GameObject toClean2 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+(i*sizeOfInt)) , Quaternion.Euler(0, 180, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
						if(i==roomSizeI-1){
							GameObject toClean2 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(0+(j*sizeOfInt)+groundTransforamX,transformY,groundTransforamZ+2+(i*sizeOfInt)) , Quaternion.Euler(0, 90, 0));
							objectsToCleanDungeon.Add(toClean2);
						}
					}
					else{									
			...
			if(dungeonSizeCounter!=dungeonSize-1){
				if(isDoorPlaceX){
					...
					for(int m = 0; m<tunelSizeX;m++){
						...
						GameObject toCleanTunsizeOfInt = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSizeJ*sizeOfFloat)+(m*sizeOfFloat)+groundTransforamX,transformY,-2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
						GameObject toCleanTun5 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3((roomSizeJ*sizeOfFloat)+(m*sizeOfFloat)+groundTransforamX,transformY,2f+(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
					...
					for(int n = 0; n<tunelSize;n++){
						if(columns.Length>0){
						GameObject toCleanTun1 =Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(-2f+doorPlaceI*sizeOfInt+groundTransforamX,transformY,-1.9f+(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0,90, 0));
						GameObject toCleanTun2 =	Instantiate(columns[Random.Range(0,columns.Length)],new Vector3(2f+doorPlaceI*sizeOfInt+groundTransforamX,transformY,-1.9f+(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0,90, 0));
						objectsToCleanDungeon.Add(toCleanTun1);
						objectsToCleanDungeon.Add(toCleanTun2);
						}
						...
						GameObject toCleanTunsizeOfInt =	Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
						GameObject toCleanTun5 =Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2f+(doorPlaceI*sizeOfInt)+groundTransforamX,transformY,(roomSizeI*sizeOfFloat)+(n*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
				...
				if(isDoorPlaceX){
					GameObject toCleanwall1 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(-2f+(roomSizeJ*sizeOfFloat)+groundTransforamX,transformY,(dootPlaceJ*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 180, 0));
					objectsToCleanDungeon.Add(toCleanwall1);
				}
				else{
					GameObject toCleanwall1 = Instantiate(walls[Random.Range(0,walls.Length)],new Vector3(doorPlaceI*sizeOfFloat+groundTransforamX,transformY,-2f+(roomSizeI*sizeOfFloat)+groundTransforamZ) , Quaternion.Euler(0, 90, 0));
					objectsToCleanDungeon.Add(toCleanwall1);
				}
			}
