...
//
//public class DungeonGeneratorNavMeshSurface : MonoBehaviour {
...
//					toClean1.GetComponent<NavMeshSurface>().BuildNavMesh();
//					objectsToCleanDungeon.Add(toClean1);
//				}
//
//				if (hasRoof)
...
//								Quaternion.Euler(0, 0, 0));
//							toClean3.GetComponent<NavMeshSurface>().BuildNavMesh();
//							objectsToCleanDungeon.Add(toClean3);
//						}
//
//						if (hasRoof)
...
//					toClean6.GetComponent<NavMeshSurface>().BuildNavMesh();
...
//							(roomSize * sizeOfInt) + (n * sizeOfInt) + groundTransforamZ), Quaternion.Euler(0, 0, 0));
//					toClean2.GetComponent<NavMeshSurface>().BuildNavMesh();
//					objectsToCleanDungeon.Add(toClean2);
//				}
//
//				if (hasRoof)
...
//									transformY, (dootPlaceJ * sizeOfFloat) + groundTransforamZ),
//								Quaternion.Euler(0, 0, 0));
//							toCleanTun3.GetComponent<NavMeshSurface>().BuildNavMesh();
